...
export function Btn({ title, onPress, reduced, disabled }: Props) {
  return (
    <TouchableOpacity
      disabled={disabled}
      className={
        (reduced ? "flex flex-row items-center justify-center gap-4 bg-[#D66A1F] rounded-lg px-8 py-[12px]" : "flex flex-row items-center justify-center gap-4 bg-[#D66A1F] rounded-lg px-10 py-[12px]") +
        (disabled ? " opacity-50" : "")
      }
      onPress={onPress}
    >
